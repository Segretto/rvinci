...
from rvinci.skills.perception.dinov3.models.backbone import DinoBackbone
from rvinci.skills.perception.dinov3.models.depth_head import DepthHeadLite
from rvinci.skills.perception.dinov3.models.instance_seg_head import (
...
class UnifiedDINOv3(nn.Module):
    def __init__(
        ...
        n_layers: int = 12,
        embed_dim: int = 384,
        depth_out_size: tuple = (640, 640),
        seg_target_size: tuple = (320, 320),
    ):
        """
